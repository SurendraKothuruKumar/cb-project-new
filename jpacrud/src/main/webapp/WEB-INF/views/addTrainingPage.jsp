		...
		<form:form action="/addTraining" method="post"
			...
			<table border="1">
				...
				<tr>
					...
					<td><form:input type="date" name="startDate" style="width: 230px"
				...
				<tr>
					...
					<td><form:input type="date" name="endDate"
							style="width: 230px" id="endDate" path="endDate" />
						<form:errors path="endDate"></form:errors></td>
				</tr>
				<tr>
					<th class="lblue labelfont"><label>Fee</label></th>
					<td><form:input type="number" name="fee"
							style="width: 230px" id="fee" path="fee" />
						<form:errors path="fee"></form:errors></td>
				</tr>
				<tr>
					<th class="lblue labelfont"><label>gst</label></th>
					<td><form:input type="number" name="gst"
							style="width: 230px" id="gst" path="gst" />
						<form:errors path="gst"></form:errors></td>
				</tr>
				<tr>
					<th class="lblue labelfont"><label>trainerName</label></th>
					<td><form:input type="text" name="trainerName"
							style="width: 230px" id="trainerName" path="trainerName" />
						<form:errors path="trainerName"></form:errors></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><form:input type="number" name="personsNominated"
							style="width: 230px" id="personsNominated" path="personsNominated" />
						<form:errors path="personsNominated"></form:errors></td>
				</tr>
				<tr>
					<th class="lblue labelfont"><label>skills</label></th>
					<td><form:input type="text" name="skills"
							style="width: 230px" id="skills" path="skills" />
						<form:errors path="skills"></form:errors></td>
				</tr>
				<tr>

					<td class="lblue labelfont" colspan="2" align="center"><input
						type="submit" value="ADD Book"></td>
				</tr>
